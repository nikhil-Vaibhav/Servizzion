...
import com.main.chatAdapters.DeliverOrderAdapter;
...
public class DeliveredOrdersFragment extends Fragment implements IntentListener {
    ...
    private void loadOrders() {
        usersCollection.document(Store.CURRENT_USER_ID).collection(Store.KEY_COLLECTION_DELIVERED_ORDERS)
                .get()
    ...
    private void showOrders(ArrayList<Order> orderArrayList) {
        adapter = new DeliverOrderAdapter(orderArrayList);
